	...
	TestWidget(parent)
{
	...
	testDescription = "Read Continuous test reads " + Def::Format(READ_CONT_SIZE) + " from device." +
			" Read operation is divided into blocks of " + Def::Format(READ_CONT_BLOCK) + " in order to draw graph." +
