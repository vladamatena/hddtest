	...
	TestWidget(parent)
{
	...
	testDescription = "Read Continuous test reads " + Format(READ_CONT_SIZE) + " from device." +
			" Read operation is divided into blocks of " + Format(READ_CONT_BLOCK) + " in order to draw graph." +
